...
function getCourseImage(courseNameEN: string) {
  switch (courseNameEN.toLowerCase()) {
    case 'yoga':
...
function Main() {
  ...
  return (
    <>
      ...
      <MainTrainingBlock>
        {courses.map(course => (
          <TrainingBlock key={course._id}>
            <img src={getCourseImage(course.nameEN)} alt={course.nameRU} />
            <TrainingButton>
              <img src='/Home/Training/Plus.svg' alt='+' />
            </TrainingButton>
            <TrainingInfo>
              <TrainingHead>{course.nameRU}</TrainingHead>
              <TrainingDescription>
                <TrainingDateTime>
                  <TrainingDate>
                    <svg
